class AppHeader extends HTMLElement {
    ...
    render() {
        ...
        this.innerHTML =
        `
            <header class="bg-[#1c1c1c] text-yellow-500 shadow-md sticky top-0 z-50">
                ...
                <div class="flex h-16 items-center justify-between">
                    ...
                    <nav class="flex items-center space-x-6">
                        ...
                        <a href="${loggedIn ? "javascript:void(0);" : "login.html"}" class="rounded-md px-4 py-2 bg-yellow-500 text-sm text-white font-bold hover:bg-white hover:text-yellow-500 transition" id="loginButton">
